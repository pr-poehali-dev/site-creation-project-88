...
const HERO_SLIDES = [
  { img: IMG6, label: "Москва. Ночь. Работа.", sub: "Аэросъёмка городской хроники" },
  { img: IMG4, label: "Магия трансформации", sub: "Съёмочная площадка в деле" },
  { img: IMG5, label: "Точность каждого действия", sub: "Профессиональное оборудование" },
      ...
      <footer style={{ borderTop: "1px solid rgba(0,245,255,0.1)", background: BGCARD }}>
        ...
        >
          ...
          {[
            ...
            { title: "Услуги",  links: ["Художественное", "Документальное", "Реклама", "Постпродакшн", "Продвижение SMM"] },
